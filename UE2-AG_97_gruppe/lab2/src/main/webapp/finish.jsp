...
//test
        	...
        	if(supportsLocalStorage()) {
				...
				var dateToStore = "<p>Letztes Spiel: " + date.toLocaleDateString(date) + " - " + date.toLocaleTimeString(date) + "</p>";
	...
	<section role="main">
		...
		<section id="roundwinner" aria-labelledby="roundwinnerheading">
			...
			<p class="roundwinnermessage">
				...
				<%=player1.getName() %>
				gewinnt das Spiel.
				<%} else if(player1.getWonRounds() < player2.getWonRounds()){%>
				<%=player2.getName() %>
				gewinnt das Spiel.
				<% } else {%>
			...
			<div id="player1info" class="playerinfo">
				...
				<p id="player1roundcounter" class="playerroundcounter">
					Gewonnene Runden: <span id="player1wonrounds"
						class="playerwonrounds"><%=player1.getWonRounds() %></span>
				</p>
			</div>
			<div id="player2info" class="playerinfo">
				...
				<p id="player2roundcounter" class="playerroundcounter">
					Gewonnene Runden: <span id="player2wonrounds"
						class="playerwonrounds"><%=player2.getWonRounds() %></span>
				</p>
			</div>
