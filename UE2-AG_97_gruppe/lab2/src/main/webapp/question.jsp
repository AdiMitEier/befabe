...
<body id="questionpage">
	...
	<section role="main">
		<section id="roundinfo" aria-labelledby="roundinfoheading">
			...
			<div id="player1info">
				<jsp:useBean id="player1" scope="session"
					class="at.ac.tuwien.big.we14.lab2.api.impl.SimplePlayer" />
				<jsp:useBean id="player2" scope="session"
					class="at.ac.tuwien.big.we14.lab2.api.impl.SimplePlayer" />
				<span id="player1name"><%=player1.getName()%></span>
				<ul class="playerroundsummary">
					<li><span class="accessibility">Frage 1:</span><span
						id="player1answer1" class="correct">Richtig</span></li>
					<li><span class="accessibility">Frage 2:</span><span
						id="player1answer2" class="incorrect">Falsch</span></li>
					<li><span class="accessibility">Frage 3:</span><span
						id="player1answer3" class="unknown">Unbekannt</span></li>
				</ul>
			</div>
			<div id="player2info">
				...
				<ul class="playerroundsummary">
					<li><span class="accessibility">Frage 1:</span><span
						id="player2answer1" class="correct">Richtig</span></li>
					<li><span class="accessibility">Frage 2:</span><span
						id="player2answer2" class="correct">Richtig</span></li>
					<li><span class="accessibility">Frage 3:</span><span
						id="player2answer3" class="unknown">Unbekannt</span></li>
				</ul>
			</div>
			<jsp:useBean id="category" scope="session"
				class="at.ac.tuwien.big.we14.lab2.api.impl.SimpleCategory" />
			<div id="currentcategory">
				<span class="accessibility">Kategorie:</span><%=category.getName()%></div>
		</section>

		<!-- Question -->
		<section id="question" aria-labelledby="questionheading">
			<form id="questionform" action="BigQuizServlet" method="post">
				<jsp:useBean id="question" scope="session"
					class="at.ac.tuwien.big.we14.lab2.api.impl.SimpleQuestion" />
				...
				<ul id="answers">
					...
					%>
					<li><input id=<%="option"+i%> type="checkbox" /><label
						for=<%="option"+i%>><%=choice.getText()%></label></li>
					<%
						i++;
					%>
					<%
		...
		<section id="lastgame">
			<p><SCRIPT type="text/javascript">lastFinishedGame();</SCRIPT></p>
		</section>
	</section>
